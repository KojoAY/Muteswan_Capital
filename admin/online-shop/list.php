<section class="display">
    <form method="post" action="save-new.php" enctype="multipart/form-data" style="position:relative;">
        ...
        <article>
			...
			$sql = "SELECT COUNT(ols_id) AS OLS_ID FROM acms_online_shop_list";
            ...
            <?php
			$SQLBOOKLIST = "SELECT * FROM acms_online_shop_list ORDER BY ols_id DESC " . " LIMIT $offset, $rowsPerPage";
